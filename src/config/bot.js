...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        // Text users will see under the bot name.
        name: "ASTRYX.net",
  ...
  verification: {
    ...
    defaultMessage: "This server requires you to verify yourself to get access to other channels, you can simply verify by clicking on the verify button.",
  ...
  // =========================
  welcome: {
    // Customized template matching the welcome screen structure.
    defaultWelcomeMessage:
      "Hey {user} Thanks for joining the community!\n\nYou are our {memberCount} member! Of ASTRYX NET!\n\nPlease read the rules and have a great time here.",
